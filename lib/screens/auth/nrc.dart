...
class NRCState extends State<NRCPage> {
  ...
  void setTownshipData() {
    if(selectedState != "") {
      selectedTownship = widget.nrcValue != "" && widget.nrcValue.startsWith("$selectedState/") ? selectedTownship : null;
      setState(() {});
  ...
  void handleNRC() {
    String nrcValue = "$selectedState/$selectedTownship($selectedCitizen)${nrcController.text}";
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    hint: Text('Township', style: TextStyle(color: Colors.black87))
                  ),
                  SizedBox(height: 20),
                  DropdownButtonFormField<String>(
                    ...
                    hint: Text('Citizen', style: TextStyle(color: Colors.black87)),
                  ),
                  SizedBox(height: 20),
                  TextField(
                  ...
                  SizedBox(height: 20),
                  ElevatedButton(
                    onPressed: selectedState != null && selectedTownship != null && selectedCitizen != null && (isNRCValidate) ? handleNRC : null,
